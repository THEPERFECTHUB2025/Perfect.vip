...
local Library do 
    ...
    local Themes = {
        ...
        ["Futuristic"] = {
            ["Window Background"] = FromRGB(20, 20, 30),
            ["Inline"] = FromRGB(30, 30, 40),
            ["Text"] = FromRGB(200, 255, 255),
            ["Section Background"] = FromRGB(25, 25, 35),
            ["Element"] = FromRGB(40, 40, 60),
            ["Border"] = FromRGB(0, 255, 255),
            ["Outline"] = FromRGB(0, 0, 0),
            ["Dark Liner"] = FromRGB(0, 255, 255),
            ["Risky"] = FromRGB(255, 50, 50),
            ["Accent"] = FromRGB(0, 255, 255)
        },
    }

    -- Set default to Futuristic theme
    Library.Theme = TableClone(Themes["Futuristic"])
    ...
    local Components = { } do
        Components.Window = function(Data)
            local Items = { } do 
                Items["Outline"] = Instances:Create(Data.IsTextButton and "TextButton" or "Frame", {
                    ...
                    -- Add drop shadow
                    DropShadow = true,
                    DropShadowColor = FromRGB(0, 255, 255),
                    DropShadowTransparency = 0.7,
                })  Items["Outline"]:AddToTheme({BackgroundColor3 = "Window Background", BorderColor3 = "Border"})
                ...
                Instances:Create("UIGradient", {
                    ...
                    Transparency = NumSequence{NumSequenceKeypoint(0, 0.1), NumSequenceKeypoint(1, 0.7)}
                })
            end
        ...
        Components.Section = function(Data)
            local Items = { } do 
                Items["Section"] = Instances:Create("Frame", {
                    ...
                    DropShadow = true,
                    DropShadowColor = Library.Theme.Accent,
                    DropShadowTransparency = 0.8,
                })  Items["Section"]:AddToTheme({BackgroundColor3 = "Section Background", BorderColor3 = "Border"})
    ...
    -- Add hover animation for buttons/toggles
    local function AddHoverEffect(item, accentColor)
        item:OnHover(function()
            item:Tween(nil, {BackgroundColor3 = accentColor or Library.Theme.Accent, BackgroundTransparency = 0.1})
        end)
        item:OnHoverLeave(function()
            item:Tween(nil, {BackgroundColor3 = Library.Theme.Element, BackgroundTransparency = 0.3})
        end)
    end

    Components.Toggle = function(Data)
        -- ...existing code...
        AddHoverEffect(Items["Toggle"], Library.Theme.Accent)
        -- ...existing code...
    end

    Components.Button = function(Data)
        -- ...existing code...
        AddHoverEffect(Items["Button"], Library.Theme.Accent)
        -- ...existing code...
    end

    Components.Dropdown = function(Data)
        -- ...existing code...
        AddHoverEffect(Items["RealDropdown"], Library.Theme.Accent)
        -- ...existing code...
    end

    Components.Colorpicker = function(Data)
        -- ...existing code...
        AddHoverEffect(Items["ColorpickerButton"], Library.Theme.Accent)
        -- ...existing code...
    end

    -- Notifications: glass effect, neon accent, animated entry/exit
    Library.Notification = function(self, Text, Duration, Color, Icon)
        local Items = { } do
            Items["Notification"] = Instances:Create("Frame", {
                Parent = Library.NotifHolder.Instance,
                ...
                DropShadow = true,
                DropShadowColor = Color or Library.Theme.Accent,
    ...
    -- Watermark: glass effect, neon accent, animated gradient
    Library.Watermark = function(self, Text, Icon)
        local Watermark = { }
        local Items = { } do
            Items["Watermark"] = Instances:Create("Frame", {
    ...
    -- Window: animated open/close, glass effect, neon accent
    Library.Window = function(self, Data)
        ...
        function Window:SetOpen(Bool)
            Window.IsOpen = Bool
            if Bool then
                Items["Outline"]:Tween(TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {BackgroundTransparency = 0.3, Size = Window.Size})
            else
                Items["Outline"]:Tween(TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.In), {BackgroundTransparency = 1, Size = UDim2.new(0, 0, 0, 0)})
            end
        end
