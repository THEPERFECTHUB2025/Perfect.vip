...
local Library do 
    ...
    -- Fonction pour créer des couleurs rainbow
    local function GetRainbowColor(offset)
        local hue = (tick() * 50 + offset) % 360
        return FromHSV(hue / 360, 1, 1)
    end

    -- Fonction pour créer un gradient rainbow
    local function CreateRainbowGradient()
        return RGBSequence{
            RGBSequenceKeypoint(0, GetRainbowColor(0)),
            RGBSequenceKeypoint(0.2, GetRainbowColor(72)),
            RGBSequenceKeypoint(0.4, GetRainbowColor(144)),
            RGBSequenceKeypoint(0.6, GetRainbowColor(216)),
            RGBSequenceKeypoint(0.8, GetRainbowColor(288)),
            RGBSequenceKeypoint(1, GetRainbowColor(360))
        }
    end
    ...
    Library = {
        ...
        -- Variables pour les effets rainbow
        RainbowEnabled = true,
        RainbowSpeed = 50,
    }
    ...
    Library.Theme = TableClone(Themes["Rainbow"])
    ...
    local Components = { } do
        Components.Window = function(Data)
            local Items = { } do 
                ...
                -- Bordure rainbow animée
                local RainbowBorder = Instances:Create("UIStroke", {
                    Parent = Items["Outline"].Instance,
                    Color = Library:GetRainbowColor(0),
                    LineJoinMode = Enum.LineJoinMode.Miter,
                    ApplyStrokeMode = Enum.ApplyStrokeMode.Border,
                    Thickness = 2
                })
                Library:RegisterRainbowElement(RainbowBorder, "UIStroke", 0)

                -- Animation de la bordure rainbow
                Library:Connect(RunService.Heartbeat, function()
                    if Library.RainbowEnabled then
                        RainbowBorder.Instance.Color = Library:GetRainbowColor(0)
                    end
                end)
                ...
                Items["Liner"] = Instances:Create("Frame", {
                    ...
                    BorderSizePixel = 0,
                    BackgroundColor3 = Library:GetRainbowColor(0)
                })
                Library:RegisterRainbowElement(Items["Liner"], "Frame", 0)

                -- Gradient rainbow pour la ligne d'accent
                local LinerGradient = Instances:Create("UIGradient", {
                    Parent = Items["Liner"].Instance,
                    Rotation = 0,
                    Color = Library:CreateRainbowGradient()
                }) 
                Library:RegisterRainbowElement(LinerGradient, "UIGradient")
            end
        ...
        Components.Page = function(Data)
            ...
            local Items = { } do 
                Items["Inactive"] = Instances:Create("TextButton", {
                    ...
                    FontFace = Library.Font,
                    TextColor3 = Library:GetRainbowColor(60),
                    BorderColor3 = FromRGB(0, 0, 0),
                    Text = Data.Name,
                    AutoButtonColor = false,
                    BackgroundTransparency = 1,
                ...
                -- Animation du texte rainbow pour les pages
                Library:Connect(RunService.Heartbeat, function()
                    if Library.RainbowEnabled then
                        Items["Inactive"].Instance.TextColor3 = Library:GetRainbowColor(60)
                    end
                end)
                ...
                Items["Liner"] = Instances:Create("Frame", {
                    ...
                    ZIndex = 2,
                    BorderSizePixel = 0,
                    BackgroundColor3 = Library:GetRainbowColor(120)
                })
                Library:RegisterRainbowElement(Items["Liner"], "Frame", 120)

                -- Gradient rainbow pour la ligne
                local LinerGradient = Instances:Create("UIGradient", {
                    Parent = Items["Liner"].Instance,
                    Rotation = 0,
                    Color = Library:CreateRainbowGradient()
                ...
                Items["Glow"] = Instances:Create("Frame", {
                    ...
                    BorderSizePixel = 0,
                    BackgroundColor3 = Library:GetRainbowColor(180)
                })

                -- Animation du glow rainbow
                Library:Connect(RunService.Heartbeat, function()
                    if Library.RainbowEnabled then
                        Items["Glow"].Instance.BackgroundColor3 = Library:GetRainbowColor(180)
                    end
                end)

                -- Gradient rainbow pour le glow
            ...
            function Page:Turn(Bool)
                ...
                if Page.Active then 
                    ...
                    Items["Liner"]:ChangeItemTheme({BackgroundColor3 = Library:GetRainbowColor(120)})

                    Items["Inactive"]:Tween(nil, {TextColor3 = Library.Theme.Accent})
                    Items["Liner"]:Tween(nil, {BackgroundColor3 = Library:GetRainbowColor(120)})
                    Items["Glow"]:Tween(nil, {BackgroundTransparency = 0, Size = UDim2New(1, 2, 1, 0)})
                else
                    Items["Inactive"]:ChangeItemTheme({TextColor3 = "Text"})
                    Items["Liner"]:ChangeItemTheme({BackgroundColor3 = Library.Theme["Dark Liner"]})
        ...
        Components.Toggle = function(Data)
            ...
            function Toggle:Set(Bool)
                ...
                if Toggle.Value then 
                    Items["Indicator"]:ChangeItemTheme({BackgroundColor3 = Library:GetRainbowColor(120)})
                    Items["Indicator"]:Tween(nil, {BackgroundColor3 = Library:GetRainbowColor(120)})

                    if not Data.Risky then 
                        Items["Text"]:ChangeItemTheme({TextColor3 = Library:GetRainbowColor(60)})
                        Items["Text"]:Tween(nil, {TextColor3 = Library:GetRainbowColor(60)})
                    end
                else
                    ...
                    if not Data.Risky then
                        Items["Text"]:ChangeItemTheme({TextColor3 = Library.Theme.Text})
        ...
        function Dropdown:Add(Option)
            ...
            function OptionData:Toggle(Status)
                if Status == "Active" then 
                    ...
                    OptionData.OptionButton:Tween(nil, {TextColor3 = Library:GetRainbowColor(120)})
    ...
    Components.Colorpicker = function(Data)
        ...
        local Items = { } do
            ...
            -- Bordure rainbow pour les pages
            local PagesBorder = Instances:Create("UIStroke", {
                Parent = Items["Pages"].Instance,
                Color = Library:GetRainbowColor(240),
                LineJoinMode = Enum.LineJoinMode.Miter,
                ApplyStrokeMode = Enum.ApplyStrokeMode.Border,
                Thickness = 2
            })
            Library:RegisterRainbowElement(PagesBorder, "UIStroke", 240)
    ...
    Components.Keybind = function(Data)
        ...
        function Keybind:SetMode(Mode)
            for Index, Value in Modes do 
                if Index == Mode then 
                    Value:ChangeItemTheme({TextColor3 = Library:GetRainbowColor(120)})
                    Value:Tween(nil, {TextColor3 = Library:GetRainbowColor(120)})
                else
        ...
        Items["KeyButton"]:Connect("MouseButton1Click", function()
            ...
            Items["KeyButton"]:Tween(nil, {TextColor3 = Library:GetRainbowColor(120)})
    ...
    Components.Textbox = function(Data)
        ...
        Items["Inline"]:Connect("Focused", function()
            ...
            Items["Inline"]:Tween(nil, {TextColor3 = Library:GetRainbowColor(120)})
        end)
    ...
    Components.Listbox = function(Data)
        ...
        function Listbox:Add(Option)
            ...
            function OptionData:Toggle(Status)
                if Status == "Active" then 
                    OptionData.OptionButton:ChangeItemTheme({TextColor3 = Library:GetRainbowColor(120)})
                    OptionData.OptionButton:Tween(nil, {TextColor3 = Library:GetRainbowColor(120)})
                else
                    OptionData.OptionButton:ChangeItemTheme({TextColor3 = "Text"})
                    OptionData.OptionButton:Tween(nil, {TextColor3 = Library.Theme.Text})
    ...
    Library.Window = function(self, Data)
        ...
        local Items = Components.Window({
            ...
            -- Bordure rainbow pour le titre
            local TitleBorder = Instances:Create("UIStroke", {
                Parent = Items["Title"].Instance,
                Color = Library:GetRainbowColor(120),
                LineJoinMode = Enum.LineJoinMode.Miter,
                ApplyStrokeMode = Enum.ApplyStrokeMode.Border,
                Thickness = 2
            })
            Library:RegisterRainbowElement(TitleBorder, "UIStroke", 120)

            Items["Text"] = Instances:Create("TextLabel", {
                Parent = Items["Title"].Instance,
                FontFace = Library.Font,
                TextColor3 = Library:GetRainbowColor(0),
                BorderColor3 = FromRGB(0, 0, 0),
                Text = Window.Name,
                Name = "\0",
            ...
            -- Animation du texte rainbow
            Library:Connect(RunService.Heartbeat, function()
                if Library.RainbowEnabled then
                    Items["Text"].Instance.TextColor3 = Library:GetRainbowColor(0)
                end
            end)

            if type(Window.GradientTitle) == "table" and Window.GradientTitle.Enabled then
                ...
                -- Effet rainbow par défaut pour le titre
                local TitleGradient = Instances:Create("UIGradient", {
                    Parent = Items["Text"].Instance,
                    Rotation = 0,
                    Color = Library:CreateRainbowGradient()
                })
                Library:RegisterRainbowElement(TitleGradient, "UIGradient")

                Items["Text"].Instance.TextColor3 = FromRGB(255, 255, 255)

                Library:Connect(RunService.Heartbeat, function()
                    if Library.RainbowEnabled then
                        TitleGradient.Instance.Color = Library:CreateRainbowGradient()
                        local GradientOffset = MathAbs(MathSin(tick() * Library.RainbowSpeed * 0.15))
                        TitleGradient.Instance.Offset = Vector2New(GradientOffset, 0)
                    end
                end)
            end
            ...
            -- Bordure rainbow pour le contenu
            local ContentBorder = Instances:Create("UIStroke", {
                Parent = Items["Content"].Instance,
                Color = Library:GetRainbowColor(180),
                LineJoinMode = Enum.LineJoinMode.Miter,
                ApplyStrokeMode = Enum.ApplyStrokeMode.Border,
                Thickness = 2
            })
            Library:RegisterRainbowElement(ContentBorder, "UIStroke", 180)
        end
    ...
    Library.Pages.PlayerList = function(self, Data)
        ...
        function Playerlist:Add(Player)
            ...
            if Player == LocalPlayer then 
                PlayerStatus.Instance.TextColor3 = Library:GetRainbowColor(120)
                PlayerStatus.Instance.Text = "LocalPlayer"
                PlayerStatus:AddToTheme({TextColor3 = Library:GetRainbowColor(120)})
            else
            ...
            function PlayerData:Toggle(Status)
                if Status == "Active" then
                    PlayerData.PlayerName:ChangeItemTheme({TextColor3 = Library:GetRainbowColor(60)})
                    PlayerData.PlayerName:Tween(nil, {TextColor3 = Library:GetRainbowColor(60)})
...
-- Ajout de la table globale pour les éléments rainbow
Library._RainbowElements = {}
Library.RainbowStaticColor = Color3.fromRGB(0, 255, 128) -- Vert fluo par défaut

-- Fonction d'enregistrement d'un élément rainbow
function Library:RegisterRainbowElement(element, elType, offset, property)
    table.insert(self._RainbowElements, {
        element = element,
        elType = elType, -- "UIStroke", "TextLabel", "Frame", "UIGradient", etc.
        offset = offset or 0,
        property = property or nil
    })
end

-- Nettoyage lors de l'Unload
local _oldUnload = Library.Unload
function Library:Unload()
    self._RainbowElements = {}
    if _oldUnload then _oldUnload(self) end
end

-- Refactorisation de GetRainbowColor et CreateRainbowGradient
function Library:GetRainbowColor(offset)
    if not self.RainbowEnabled then
        return self.RainbowStaticColor
    end
    local hue = (tick() * self.RainbowSpeed + (offset or 0)) % 360
    return Color3.fromHSV(hue / 360, 1, 1)
end

function Library:CreateRainbowGradient()
    if not self.RainbowEnabled then
        return ColorSequence.new(self.RainbowStaticColor)
    end
    return ColorSequence.new({
        ColorSequenceKeypoint.new(0, self:GetRainbowColor(0)),
        ColorSequenceKeypoint.new(0.2, self:GetRainbowColor(72)),
        ColorSequenceKeypoint.new(0.4, self:GetRainbowColor(144)),
        ColorSequenceKeypoint.new(0.6, self:GetRainbowColor(216)),
        ColorSequenceKeypoint.new(0.8, self:GetRainbowColor(288)),
        ColorSequenceKeypoint.new(1, self:GetRainbowColor(360))
    })
end

-- Boucle Heartbeat unique pour tous les éléments rainbow
if Library._RainbowHeartbeat then Library._RainbowHeartbeat:Disconnect() end
Library._RainbowHeartbeat = game:GetService("RunService").Heartbeat:Connect(function()
    for _, data in ipairs(Library._RainbowElements) do
        local color = Library:GetRainbowColor(data.offset)
        if data.elType == "UIStroke" or data.elType == "Frame" or data.elType == "TextLabel" then
            if data.property then
                if data.element and data.element.Instance then
                    data.element.Instance[data.property] = color
                elseif data.element then
                    data.element[data.property] = color
                end
            else
                if data.element and data.element.Instance then
                    if data.elType == "UIStroke" then
                        data.element.Instance.Color = color
                    elseif data.elType == "Frame" then
                        data.element.Instance.BackgroundColor3 = color
                    elseif data.elType == "TextLabel" then
                        data.element.Instance.TextColor3 = color
                    end
                elseif data.element then
                    if data.elType == "UIStroke" then
                        data.element.Color = color
                    elseif data.elType == "Frame" then
        ...
        elseif data.elType == "UIGradient" then
            if data.element and data.element.Instance then
                data.element.Instance.Color = Library:CreateRainbowGradient()
            elseif data.element then
                data.element.Color = Library:CreateRainbowGradient()
            end
        end
    end
end)

-- Ajout de thèmes avancés
Library.Themes["Holographique"] = {
    ["Window Background"] = Color3.fromRGB(30, 34, 54),
    ["Inline"] = Color3.fromRGB(40, 44, 74),
    ["Text"] = Color3.fromRGB(200, 220, 255),
    ["Section Background"] = Color3.fromRGB(50, 54, 94),
    ["Element"] = Color3.fromRGB(80, 90, 140),
    ["Border"] = Color3.fromRGB(120, 80, 200),
    ["Outline"] = Color3.fromRGB(80, 40, 120),
    ["Dark Liner"] = Color3.fromRGB(60, 30, 90),
    ["Risky"] = Color3.fromRGB(255, 50, 200),
    ["Accent"] = Color3.fromRGB(120, 200, 255)
}
Library.Themes["Light"] = {
    ["Window Background"] = Color3.fromRGB(240, 240, 255),
    ["Inline"] = Color3.fromRGB(220, 220, 240),
    ["Text"] = Color3.fromRGB(40, 40, 60),
    ["Section Background"] = Color3.fromRGB(230, 230, 250),
    ["Element"] = Color3.fromRGB(200, 200, 220),
    ["Border"] = Color3.fromRGB(180, 180, 200),
    ["Outline"] = Color3.fromRGB(160, 160, 180),
    ["Dark Liner"] = Color3.fromRGB(120, 120, 140),
    ["Risky"] = Color3.fromRGB(255, 50, 50),
    ["Accent"] = Color3.fromRGB(120, 180, 255)
}
Library.Themes["Dark"] = {
    ["Window Background"] = Color3.fromRGB(24, 24, 32),
    ["Inline"] = Color3.fromRGB(32, 32, 48),
    ["Text"] = Color3.fromRGB(200, 200, 220),
    ["Section Background"] = Color3.fromRGB(36, 36, 54),
    ["Element"] = Color3.fromRGB(60, 60, 90),
    ["Border"] = Color3.fromRGB(80, 80, 120),
    ["Outline"] = Color3.fromRGB(40, 40, 60),
    ["Dark Liner"] = Color3.fromRGB(30, 30, 40),
    ["Risky"] = Color3.fromRGB(255, 50, 50),
    ["Accent"] = Color3.fromRGB(120, 180, 255)
}
...
function Library:ApplyTheme(name)
    if self.Themes[name] then
        self.Theme = TableClone(self.Themes[name])
        -- Met à jour tous les éléments thématisés
        for _, item in ipairs(self.ThemeItems) do
            for property, value in pairs(item.Properties) do
                if type(value) == "string" and self.Theme[value] then
                    item.Item[property] = self.Theme[value]
                end
            end
        end
        -- Met à jour tous les éléments rainbow
        if name ~= "Rainbow" then
            self.RainbowEnabled = false
            self.RainbowStaticColor = self.Theme["Accent"] or Color3.fromRGB(0,255,128)
        else
...
-- Ajout d'un Dropdown de sélection de thème dans la fenêtre principale
local _oldWindow = Library.Window
function Library:Window(Data)
    local win = _oldWindow(self, Data)
    -- Ajoute le dropdown de sélection de thème dans la première page/section
    local themeNames = {}
    for k, _ in pairs(self.Themes) do table.insert(themeNames, k) end
    table.sort(themeNames)
    local page = win:Page({Name = "🎨 Thème", Columns = 1})
    local section = page:Section({Name = "Sélection du thème", Side = 1})
    section:Dropdown({
        Name = "Thème UI",
        Items = themeNames,
        Default = "Rainbow",
...
function Library:SetRainbowEnabled(enabled)
