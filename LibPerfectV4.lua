...
local Library do 
    ...
    local Instances = { } do
        ...
        Instances.Clean = function(self)
            ...
            -- Vérifie si c'est bien un Instance Roblox
            if typeof(self.Instance) == "Instance" and typeof(self.Instance.Destroy) == "function" then
    ...
    Library.Watermark = function(self, Text, Icon)
        ...
        local Items = { } do
            ...
            stroke.Parent = Items["Watermark"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Liner"].Instance
    ...
    Library.KeybindList = function(self)
        ...
        local Items = { } do 
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["KeybindListOutline"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Inline"].Instance
            ...
            Items["Title"] = Instances:Create("Frame", {
                Parent = Items["Inline"].Instance,
                Name = "\0",
                Size = UDim2.new(0.25, 0, 0, 40), -- Largeur réduite, hauteur 40px
                Position = UDim2.new(0, 20, 0, 15), -- Décalé un peu du bord
                BorderColor3 = FromRGB(0, 0, 0),
                BorderSizePixel = 0,
                AutomaticSize = Enum.AutomaticSize.X,
                BackgroundColor3 = FromRGB(31, 226, 130)
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Title"].Instance
    ...
    Library.Notification = function(self, Text, Duration, Color, Icon)
        local Items = { } do
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Notification"].Instance
        ...
        if Icon then
            if type(Icon) == "table" then
                ...
                local stroke = Instance.new("UIStroke")
                stroke.Thickness = 1.5
                stroke.Parent = Items["Icon"].Instance
    ...
    local Components = { } do
        ...
        Components.Section = function(Data)
            local Items = { } do 
                ...
                local stroke = Instance.new("UIStroke")
                stroke.Thickness = 1.5
                stroke.Parent = Items["Section"].Instance
        ...
        Components.Toggle = function(Data)
            ...
            local Items = { } do 
                ...
                local stroke = Instance.new("UIStroke")
                stroke.Thickness = 1.5
                stroke.Parent = Items["Toggle"].Instance
                ...
                local stroke = Instance.new("UIStroke")
                stroke.Thickness = 1.5
                stroke.Parent = Items["Indicator"].Instance
    ...
    Components.Button = function(Data)
        ...
        local Items = { } do 
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Button"].Instance
        ...
        function Button:SubButton(Data)
            ...
            local SubItems = { } do 
                ...
                local stroke = Instance.new("UIStroke")
                stroke.Thickness = 1.5
                stroke.Parent = SubItems["Button"].Instance
    ...
    Components.Slider = function(Data)
        ...
        local Items = { } do
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["RealSlider"].Instance
    ...
    Components.Dropdown = function(Data)
        ...
        local Items = { } do
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["RealDropdown"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Value"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["OpenIcon"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["OptionHolder"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Holder"].Instance
    ...
    Components.Colorpicker = function(Data)
        ...
        local Items = { } do
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["ColorpickerButton"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Content"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Palette"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["PaletteDragger"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Saturation"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Alpha"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Checkers"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["AlphaDragger"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Hue"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["HueDragger"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["CurrentColor"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["RGB"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["HSV"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Hex"].Instance
    ...
    Components.Keybind = function(Data)
        ...
        local Items = { } do
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["KeyButton"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["KeybindWindow"]["Outline"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Hold"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Always"].Instance
        end
    ...
    Components.Textbox = function(Data)
        ...
        local Items = { } do
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Background"].Instance
    ...
    Components.Listbox = function(Data)
        ...
        local Items = { } do
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Listbox"].Instance
    ...
    Library.Window = function(self, Data)
        ...
        local Items = Components.Window({
            ...
            corner.CornerRadius = UDim.new(0, 8) -- Radius plus petit
            corner.Parent = Items["Title"].Instance
            ...
            local corner = Instance.new("UICorner")
            corner.CornerRadius = UDim.new(0, 8) -- Radius plus petit
            corner.Parent = Items["Pages"].Instance
            ...
            local corner = Instance.new("UICorner")
            corner.CornerRadius = UDim.new(0, 8) -- Radius plus petit
            corner.Parent = Items["Content"].Instance
    ...
    Library.Pages.Section = function(self, Data)
        ...
        local corner = Instance.new("UICorner")
        corner.CornerRadius = UDim.new(0, 8) -- Radius plus petit
        corner.Parent = Items["Section"].Instance
    ...
    Library.Pages.PlayerList = function(self, Data)
        ...
        local Items = { } do
            ...
            corner.Parent = Items["Playerlist"].Instance

            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Playerlist"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Text"].Instance
            ...
            local corner = Instance.new("UICorner")
            corner.CornerRadius = UDim.new(0, 10)
            corner.Parent = Items["Avatar"].Instance

            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Avatar"].Instance
            ...
            local corner = Instance.new("UICorner")
            corner.CornerRadius = UDim.new(0, 10)
            corner.Parent = Items["Holder"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["Username"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = Items["UserID"].Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = PlayerStatusModeDropdownItems["Dropdown"].Instance
        end
        ...
        function Playerlist:Add(Player)
            ...
            local corner = Instance.new("UICorner")
            corner.CornerRadius = UDim.new(0, 10)
            corner.Parent = PlayerBackground.Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = PlayerName.Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = PlayerTeam.Instance
            ...
            local stroke = Instance.new("UIStroke")
            stroke.Thickness = 1.5
            stroke.Parent = PlayerStatus.Instance
...
--[[
    ...
    -- Nouvelles fonctions Rainbow:
    function Library:SetRainbowEnabled(Enabled: boolean)
    function Library:SetRainbowSpeed(Speed: number)
    function Library:GetRainbowColor(Offset: number)
    function Library:CreateRainbowGradient()
]]

-- Exemple d'utilisation avec effets rainbow:
--[[
...
local Section = Page:Section({
    Name = "Rainbow Controls",
    Side = 1
})

-- Contrôles pour les effets rainbow
Section:Toggle({
    Name = "Enable Rainbow Effects",
    Default = true,
    Flag = "RainbowEnabled",
    Callback = function(Value)
        Library:SetRainbowEnabled(Value)
    end
})
...
Section:Slider({
    ...
    Flag = "RainbowSpeed",
    Callback = function(Value)
        Library:SetRainbowSpeed(Value)
    end
})

Section:Button({
    Name = "Random Rainbow Colors",
    Callback = function()
        -- Change aléatoirement les couleurs rainbow
        local RandomOffset = math.random(0, 360)
        Library:SetRainbowSpeed(math.random(30, 80))
    end
})
]]
