            ...
            local Items = { } do 
                ...
                Library:Connect(RunService.Heartbeat, function()
                    if Library.RainbowEnabled then
                        ...
                        RainbowBorder.Instance.Color = Color3.fromRGB(31, 226, 130)
                    end
                end)
                ...
                Library:Connect(RunService.Heartbeat, function()
                    if Library.RainbowEnabled then
                        ...
                        LinerGradient.Instance.Color = ColorSequence.new(Color3.fromRGB(31, 226, 130))
                        LinerGradient.Instance.Offset = Vector2New(0, 0)
                    end
                end)

                -- Ajout du texte de crédit en bas de la fenêtre
                Items["Credit"] = Instances:Create("TextLabel", {
                    Parent = Items["Outline"].Instance,
                    Name = "CreditLabel",
                ...
                Library:Connect(RunService.Heartbeat, function()
                    if Library.RainbowEnabled then
                        Items["Credit"].Instance.TextColor3 = GetRainbowColor(tick() * 100)
                    else
                        Items["Credit"].Instance.TextColor3 = Color3.fromRGB(31, 226, 130)
                    end
                end)

                -- Ajout d'une ombre pour le texte de crédit
                local CreditShadow = Instances:Create("TextLabel", {
                    Parent = Items["Outline"].Instance,
                    Name = "CreditShadow",
                    AnchorPoint = Vector2New(0.5, 1),
                    Position = UDim2.new(0.5, 0, 1, -22),
                ...
                Library:Connect(RunService.Heartbeat, function()
                    CreditShadow.Instance.Position = Items["Credit"].Instance.Position
                end)
            end
            ...
            local Items = { } do 
                ...
                Library:Connect(RunService.Heartbeat, function()
                    if Library.RainbowEnabled then
                        ...
                        Items["Inactive"].Instance.TextColor3 = Color3.fromRGB(31, 226, 130)
                    end
                end)
                ...
                Library:Connect(RunService.Heartbeat, function()
                    if Library.RainbowEnabled then
                        ...
                        Items["Liner"].Instance.BackgroundColor3 = Color3.fromRGB(31, 226, 130)
                    end
                end)
                ...
                Library:Connect(RunService.Heartbeat, function()
                    if Library.RainbowEnabled then
                        ...
                        Items["Glow"].Instance.BackgroundColor3 = Color3.fromRGB(31, 226, 130)
                    end
                end)
    ...
    Components.Colorpicker = function(Data)
        ...
        local Items = { } do
            ...
            Library:Connect(RunService.Heartbeat, function()
                if Library.RainbowEnabled then
                    ...
                    PagesBorder.Instance.Color = Color3.fromRGB(31, 226, 130)
                end
            end)
        ...
        function Colorpicker:SetOpen(Bool)
            ...
            if Colorpicker.IsOpen then 
                ...
                for _, Value in pairs(Items["ColorpickerWindow"]["Outline"].Instance:GetDescendants()) do 
                    if not StringFind(Value.ClassName, "UI") then
                        Value.ZIndex = 25
                    end
                end
    ...
    Components.Keybind = function(Data)
        ...
        function Keybind:SetOpen(Bool)
            ...
            if Bool then 
                ...
                for _, Value in pairs(Items["KeybindWindow"]["Outline"].Instance:GetDescendants()) do 
                    if not StringFind(Value.ClassName, "UI") then
                        Value.ZIndex = 17
                    end
                end
        ...
        local Items = Components.Window({
            ...
            Library:Connect(RunService.Heartbeat, function()
                if Library.RainbowEnabled then
                    ...
                    TitleBorder.Instance.Color = Color3.fromRGB(31, 226, 130)
                end
            end)
            ...
            Library:Connect(RunService.Heartbeat, function()
                if Library.RainbowEnabled then
                    ...
                    Items["Text"].Instance.TextColor3 = Color3.fromRGB(31, 226, 130)
                end
            end)
            ...
            if type(Window.GradientTitle) == "table" and Window.GradientTitle.Enabled then
                ...
                Library:Connect(RunService.Heartbeat, function()
                    if Library.RainbowEnabled then
                        ...
                        TitleGradient.Instance.Color = ColorSequence.new(Color3.fromRGB(31, 226, 130))
                        TitleGradient.Instance.Offset = Vector2New(0, 0)
                    end
                end)
            end
            ...
            Library:Connect(RunService.Heartbeat, function()
                if Library.RainbowEnabled then
                    ...
                    ContentBorder.Instance.Color = Color3.fromRGB(31, 226, 130)
                end
            end)
