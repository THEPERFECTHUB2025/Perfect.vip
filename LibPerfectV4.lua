        ...
        Components.Window = function(Data)
            local Items = { } do 
                ...
                Items["Credit"] = Instances:Create("TextLabel", {
                    Parent = Items["Inline"].Instance, -- ATTENTION : on met le parent sur le fond noir !
                    Name = "CreditLabel",
                    AnchorPoint = Vector2.new(0.5, 1),
                    Position = UDim2.new(0.5, 0, 1, -15), -- Décalé de 6px au-dessus du bas du fond noir
                    Size = UDim2.new(1, -40, 0, 18),     -- Un peu moins large pour ne pas toucher les bords
                    BackgroundTransparency = 1,
                    BorderSizePixel = 0,
                    Text = "<font color=\"#ff0000\">THE PERFECT EXPLOITER</font>",
