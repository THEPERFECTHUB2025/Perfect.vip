...
do
	...
	do
        ...
        function Sections:Toggle(Options)
            ...
            -- Modify SetState to dynamically adjust toggle colors
            local function SetState()
                Toggle.Toggled = not Toggle.Toggled
                if Toggle.Toggled then
                    Accent.Visible = true
                    Frame.BackgroundColor3 = Color3.fromRGB(0, 255, 0) -- Green when active
                    TextLabel.TextColor3 = Color3.fromRGB(0, 255, 0) -- Green text when active
                else
                    Accent.Visible = false
                    Frame.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- Default background color
                    TextLabel.TextColor3 = Color3.fromRGB(255, 255, 255) -- Default white text
                end
