		...
		function Pages:Section(Options)
            ...
            function Sections:Toggle(Options)
                ...
                local Toggle = {
                    ...
                    Page = self.Page,
                    Section = self,
                    Name = Properties.Name or Properties.name or Properties.Title or Properties.title or "Toggle",
                    ...
                    Toggled = false,
                    ActiveColor = Color3.fromRGB(0, 255, 0), -- Bright green for active state
                    InactiveColor = Color3.fromRGB(254, 207, 17), -- Default yellow for inactive state
                }
            
                local Holder = Instance.new("Frame", Toggle.Section.Elements.Left)
                ...
                TextLabel.TextColor3 = Toggle.InactiveColor
                ...
                Accent.Position = UDim2.new(1, -15, 0.5, -5)
                ...
                local function SetState()
                    ...
                    if Toggle.Toggled then
                        Accent.Visible = true
                        TextLabel.TextColor3 = Toggle.ActiveColor -- Set to active color
                    else
                        Accent.Visible = false
                        TextLabel.TextColor3 = Toggle.InactiveColor -- Set to inactive color
                    end
