...
do
	...
	do
        ...
        function Sections:Toggle(Options)
            ...
            local Outline = Instance.new('UIStroke', Frame) -- Add green outline
            -- 
            do -- Inserts
                table.insert(Library.Instances, Frame)
                table.insert(Library.Instances, Accent)
            ...
            Gradient.Name = "Gradient"
            Gradient.Color = ColorSequence.new{
                ColorSequenceKeypoint.new(0, Color3.new(0.7804, 0.7490, 0.8000)),
            ...
            -- 
            Outline.Thickness = 2 -- Set outline thickness
            Outline.Color = Color3.fromRGB(0, 255, 0) -- Green color
            ...
            local function SetState()
                ...
                if Toggle.Toggled then
                    Accent.Visible = true
                    Outline.Enabled = true -- Enable green outline
                    TextLabel.TextColor3 = Color3.fromRGB(254, 207, 17)
                else
                    Accent.Visible = false
                    Outline.Enabled = false -- Disable green outline
                    TextLabel.TextColor3 = Color3.fromRGB(254, 207, 17)
                end
